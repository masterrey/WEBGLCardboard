...
namespace TiltShift.Cardboard
{
    ...
    public static partial class CardboardDeviceReflection
    {
        ...
        static CardboardDeviceReflection()
        {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::TiltShift.Cardboard.DeviceParams), global::TiltShift.Cardboard.DeviceParams.Parser, new[]{ "Vendor", "Model", "ScreenToLensDistance", "InterLensDistance", "LeftEyeFieldOfViewAngles", "VerticalAlignment", "TrayToLensDistance", "DistortionCoefficients", "PrimaryButton" }, null, new[]{ typeof(global::TiltShift.Cardboard.DeviceParams.Types.VerticalAlignmentType), typeof(global::TiltShift.Cardboard.DeviceParams.Types.ButtonType) }, null, null)
                }));
        }
        #endregion
    ...
    public sealed partial class DeviceParams : pb::IMessage<DeviceParams>
    {
        ...
        {
            get { return global::TiltShift.Cardboard.CardboardDeviceReflection.Descriptor.MessageTypes[0]; }
        }
        ...
        public DeviceParams(byte[] array) 
        {
            MergeFrom(new pb.CodedInputStream(array));
            OnConstruction();
        }
        ...
        private readonly static float InterLensDistanceDefaultValue = 0.05F;
        ...
        {
            get { if ((_hasBits0 & 2) != 0) { return Mathf.Clamp(interLensDistance_, 0.03f, 0.075f); } else { return InterLensDistanceDefaultValue; } }
            set
            {
                _hasBits0 |= 2;
        ...
        private readonly static global::TiltShift.Cardboard.DeviceParams.Types.VerticalAlignmentType VerticalAlignmentDefaultValue = global::TiltShift.Cardboard.DeviceParams.Types.VerticalAlignmentType.Bottom;

        private global::TiltShift.Cardboard.DeviceParams.Types.VerticalAlignmentType verticalAlignment_;

        public string SummaryInfoString()
        {
            var sb = new StringBuilder();
            sb.AppendLine($"Device info: {this.Vendor}");
            sb.AppendLine($"Model: {this.Model}");
            sb.AppendLine($"TrayToLensDistance: {this.TrayToLensDistance}");
            sb.AppendLine($"ScreenToLensDistance: {this.ScreenToLensDistance}");
            sb.AppendLine($"PrimaryButton: {this.PrimaryButton}");
            sb.AppendLine($"VerticalAlignment: {this.VerticalAlignment}");
            sb.AppendLine($"InterLensDistance: {this.InterLensDistance}");
            return sb.ToString();
        }
        ...
        /// </summary>
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        public global::TiltShift.Cardboard.DeviceParams.Types.VerticalAlignmentType VerticalAlignment
        {
        ...
        private readonly static global::TiltShift.Cardboard.DeviceParams.Types.ButtonType PrimaryButtonDefaultValue = global::TiltShift.Cardboard.DeviceParams.Types.ButtonType.Magnet;

        private global::TiltShift.Cardboard.DeviceParams.Types.ButtonType primaryButton_;
        /// <summary>
        ...
        /// </summary>
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        public global::TiltShift.Cardboard.DeviceParams.Types.ButtonType PrimaryButton
        {
        ...
        public void MergeFrom(pb::CodedInputStream input)
        {
            ...
            while ((tag = input.ReadTag()) != 0)
            {
                switch (tag)
                {
                    ...
                    case 88:
                        {
                            VerticalAlignment = (global::TiltShift.Cardboard.DeviceParams.Types.VerticalAlignmentType)input.ReadEnum();
                            break;
                        }
                    case 96:
                        {
                            PrimaryButton = (global::TiltShift.Cardboard.DeviceParams.Types.ButtonType)input.ReadEnum();
                            break;
                        }
                }
            }
